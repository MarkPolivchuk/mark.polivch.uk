          ...
          <Card className="sm:rounded-lg border-t-4 border-yellow-dark mb-8 p-4 flex-grow">
            ...
            <div className="mb-4 flex align-leading">
              <a href="https://www.farcast.com/" target="_blank" rel="noopener noreferrer" alt="Farcast">
                <img src="/assets/img/farcast.png" className="h-12 w-12 rounded inline-block mr-2 border border-grey-light" alt="Farcast" />
              </a>
              <div className="flex-1 inline-block">
            ...
            <div className="mb-4 flex align-leading">
              <a href="https://www.gpspolice.com/" target="_blank" rel="noopener noreferrer" alt="GPS Police">
                <img src="/assets/img/gps.png" className="h-12 w-12 rounded inline-block mr-2 border border-grey-light" alt="GPS Police" />
              </a>
              <div className="flex-1 inline-block">
            ...
            <div className="mb-4 flex align-leading">
              <a href="https://hbi.ucalgary.ca//" target="_blank" rel="noopener noreferrer" alt="Hotchkiss Brain Institute">
                <img src="/assets/img/hbi.jpeg" className="h-12 w-12 rounded inline-block mr-2 border border-grey-light" alt="Hotchkiss Brain Institute" />
              </a>
              <div className="flex-1 inline-block">
        ...
        <Row className="-mx-4">
          ...
          <Col md="1/2" className="px-4">
            <form action="submit" className="flex flex-col h-full">
              <input type="email" className="mb-4 p-4 bg-grey-lighter focus:bg-grey-lightest border-2 border-grey-lighter hover:border-grey-light focus:border-grey hover:cursor-pointer rounded-lg font-bold" placeholder="Email" />
              <input type="text" className="mb-4 p-4 bg-grey-lighter focus:bg-grey-lightest border-2 border-grey-lighter hover:border-grey-light focus:border-grey hover:cursor-pointer rounded-lg font-bold" placeholder="Subject" />
              <textarea name="body" id="" rows="6" className="flex-grow mb-4 p-4 bg-grey-lighter focus:bg-grey-lightest border-2 border-grey-lighter hover:border-grey-light focus:border-grey hover:cursor-pointer rounded-lg font-bold" placeholder="What do you want to know?" />
              <button className="self-end px-4 py-2 text-green-dark hover:text-green-lightest focus:text-green-lightest rounded bg-green-lightest hover:bg-green focus:bg-green font-bold">Submit</button>
            </form>
          </Col>
        </Row>
      </Card>
